...
float UMMC_MaxStamina::CalculateBaseMagnitude_Implementation(const FGameplayEffectSpec& Spec) const
{
	...
	//Fighter starting Stamina = 10, gets plus 6 Stamina every level
	//Can also add feat later if desired, will later be shown on GAS 127 onward.
	//return ClassStartingStamina + ConstitutionModifier + PlayerLevelClassStaminaAdd + FeatHPxPlayerLevel
